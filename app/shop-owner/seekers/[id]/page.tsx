...
export default function SeekerDetailPage() {
            ...
            <div className="min-h-screen bg-indigo-50 dark:bg-gray-900 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <Link
                        ...
                        className="inline-flex items-center gap-2 px-6 py-3 text-white rounded-xl font-semibold hover:shadow-lg transition-all"
                        style={{
    ...
    return (
        <div className="min-h-screen bg-indigo-50 dark:bg-gray-900">
            ...
            {/* Header */}
            <PageHeader
                title="รายละเอียดผู้สมัครงาน"
            />

            {/* Main Content */}
            <div className="relative max-w-7xl mx-auto px-4 py-8">
                {/* Profile Card */}
                <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl mb-8 border border-blue-100 dark:border-blue-900/50">
                    <div className="flex flex-col md:flex-row gap-8">
                        {/* Avatar Section */}
                        <div className="shrink-0">
                            <div className="relative">
                                <div className="w-40 h-40 rounded-3xl bg-blue-400 p-1">
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {days.map((day: string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<string | number | bigint | boolean | React.ReactPortal | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | null | undefined> | null | undefined, index: React.Key | null | undefined) => (
                                                <span
                                                    key={index}
                                                    className="px-4 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded-full text-sm font-medium border border-blue-200 dark:border-blue-800"
                                                >
                                                    {day}
                                                </span>
                                            ))}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div className="rounded-2xl p-6 text-white shadow-xl" style={{ backgroundColor: 'var(--button-primary)' }}>
                ...
                <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-purple-100 dark:border-purple-900/50 overflow-hidden">
                    ...
                    <div className="flex border-b border-gray-200 dark:border-gray-700">
                        <button
                            ...
                            style={activeTab === 'overview' ? { backgroundColor: 'var(--button-primary)' } : {}}
                        >
                        ...
                        <button
                            ...
                            style={activeTab === 'applications' ? { backgroundColor: 'var(--button-primary)' } : {}}
                        >
                            <div className="flex items-center justify-center gap-2">
                                    ...
                                    <div className="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-6 border border-blue-200 dark:border-blue-800">
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <span className="font-bold text-blue-700 dark:text-blue-400">{stats.pendingApplications}</span>
                                            </div>
                                            <div className="flex justify-between items-center">
                                            ...
                                            <div className="flex justify-between items-center">
                                                ...
                                                <span className="font-bold text-blue-700 dark:text-blue-400">{stats.completedApplications}</span>
                                            </div>
                                            <div className="flex justify-between items-center">
                                                <span className="text-gray-600 dark:text-gray-400">เลิกจ้าง</span>
                                                <span className="font-bold text-blue-700 dark:text-blue-400">{stats.terminatedApplications}</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="space-y-4">
                                {seeker.applications.length === 0 ? (
                                    ...
                                    seeker.applications.map((app) => (
                                        <div
                                            key={app.id}
                                            className="bg-white dark:bg-gray-700 rounded-2xl p-6 border border-purple-100 dark:border-purple-800 hover:shadow-lg transition-all"
                                        >
